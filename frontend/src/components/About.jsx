        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              I've participated in prestigious national competitions including <span className="font-semibold text-indigo-600 dark:text-indigo-400">Robocon</span> and <span className="font-semibold text-indigo-600 dark:text-indigo-400">Robofest</span>. 
          ...
          <div className="grid grid-cols-1 gap-6">
            <div className="bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-indigo-900/20 dark:to-blue-900/20 p-6 rounded-xl border border-indigo-100 dark:border-indigo-800">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Innovation-Driven</h3>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-6 rounded-xl border border-blue-100 dark:border-blue-800">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Competition Veteran</h3>
                  <p className="text-gray-600 dark:text-gray-400">
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-indigo-900/20 dark:to-blue-900/20 p-6 rounded-xl border border-indigo-100 dark:border-indigo-800">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Hands-On Builder</h3>
                  <p className="text-gray-600 dark:text-gray-400">
